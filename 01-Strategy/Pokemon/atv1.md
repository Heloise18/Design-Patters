...
while (true)
{
    ...
    Glaceon.HP -= Glaceon.Strikes[atackP1].Damage;
    Charizard.HP -= Charizard.Strikes[atackP1].Damage;

    
    Console.WriteLine($"{Glaceon.Name}            |   {Charizard.Name}");
    Console.WriteLine($"Attack: {Glaceon.Strikes[atackP1].Name}          {Charizard.Strikes[atackP2].Name}");
    Console.WriteLine($"HP: {Glaceon.HP}                   {Charizard.HP}");

    if(Glaceon.HP > Glaceon.HP)
        Winner = Glaceon;
    else
        Winner = Charizard;
